...
sys.path.insert(0,'/Users/jayden/Desktop/Business/AZ-Permit-Radar/.azpr-v10.1-offline-validation/source/AZPR-autonomous-execution-primed-draft-v10.1/trusted-installation')
from v9_transaction import AuthorizationTransactionStore,InstallerGlobalLock
i=sys.argv[1]; root=Path('/Users/jayden/Desktop/Business/AZ-Permit-Radar/AZPR/.integration-temp/offline-validation/tmp/pytest-of-jayden/pytest-2/test_f02_f04_twenty_process_sa0')
try:
